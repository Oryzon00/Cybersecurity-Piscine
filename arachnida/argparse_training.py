...
parser.add_argument("echo", help="echo your string", type=str)

# add optional argument
parser.add_argument("--test", help="optional argument", choices=[0, 1, 2 , 3], type=int)

# optional flag without arugment
parser.add_argument("-o", "--optional", help="boolean flag", action="store_true")
